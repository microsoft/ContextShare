...
echo "Building PromptVault VSIX..."
...
npm install --prefix promptvault-extension/
bash promptvault-extension/build_vsix.sh
bash promptvault-extension/install_locally.sh
```
...
*This document serves as the definitive architectural reference for the PromptVault VS Code Extension. All development, maintenance, and evolution decisions should align with the principles and patterns described herein.*
