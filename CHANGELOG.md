...
## [Unreleased]
### Changed
- Updated activity bar icon to a catalog book design that better represents the PromptVault functionality. The new icon features a book/catalog with organized content lines and a small AI indicator dot.
